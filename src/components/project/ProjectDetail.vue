        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <button @click="addPersonnel" class="btn btn-primary btn-sm">+ 添加</button>
                    <br><br>
                    <personnel-list :project-id="project.id"></personnel-list>
                </div>

            </div>
            <div class="card-body">
                <div class="h4">缺陷列表</div>
                <project-defect-list :project-id="project.id"></project-defect-list>
            </div>
        </div>
    </div>
</template>
